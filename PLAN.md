...
## Этап 14. RGB подсветка и системные устройства [TODO]
- Обнаружение и управление RGB подсветкой через I2C (материнские платы, видеокарты, периферия).
- Интеграция с OpenRGB API или прямое I2C управление RGB контроллерами.
- Синхронизация RGB эффектов с настройками мониторов (цветовая температура → RGB тон).
- Проверка: управление RGB подсветкой системы, сохранение профилей.
- Примечания: поддержка популярных RGB контроллеров (ASUS Aura, MSI Mystic Light, etc.)

## Этап 15. Завершение MVP и шлифовка [TODO]
